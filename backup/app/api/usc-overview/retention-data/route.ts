...
export async function GET(request: NextRequest) {
  try {
    ...
    console.log('📊 [USC Overview Retention API] Fetching retention data with USC lock:', {
    ...
    console.log('✅ [USC Overview Retention API] Retention data loaded:', {
    ...
    console.error('❌ [USC Overview Retention API] Error:', error)
    return NextResponse.json({ 
      success: false, 
