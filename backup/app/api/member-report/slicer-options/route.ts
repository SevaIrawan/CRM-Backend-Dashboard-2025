...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    console.log('✅ Member_report_daily slicer options processed:', {
    ...
    console.error('❌ Error fetching member_report_daily slicer options:', error)
    return NextResponse.json({ 
      success: false, 
      error: 'Internal server error while fetching member_report_daily slicer options' 
    }, { status: 500 })
  }
}
