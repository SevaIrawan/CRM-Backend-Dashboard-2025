...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log('📥 Exporting member_report_daily data with filters:', { 
    ...
    console.log(`📊 Exporting ${data.length} member_report_daily records`)
    ...
    const filename = `member_report_daily_data_${filterStr}_${timestamp}.csv`
