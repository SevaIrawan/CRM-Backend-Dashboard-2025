...
export async function GET(request: NextRequest) {
  ...
  try {
    console.log('🔍 [USC Customer Retention API] Fetching slicer options for USC currency lock')
    ...
    console.log('✅ [USC Customer Retention API] Slicer options loaded with USC currency lock:', {
    ...
    console.error('❌ [USC Customer Retention API] Error getting slicer options:', error)
    return NextResponse.json({ 
      success: false, 
