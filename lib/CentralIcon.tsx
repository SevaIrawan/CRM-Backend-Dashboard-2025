...
export const KPI_ICONS = {
  ...
  growthProfitabilityChart: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"><!--!Font Awesome Free v7.0.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.--><path d="M128 128C128 110.3 113.7 96 96 96C78.3 96 64 110.3 64 128L64 464C64 508.2 99.8 544 144 544L544 544C561.7 544 576 529.7 576 512C576 494.3 561.7 480 544 480L144 480C135.2 480 128 472.8 128 464L128 128zM534.6 214.6C547.1 202.1 547.1 181.8 534.6 169.3C522.1 156.8 501.8 156.8 489.3 169.3L384 274.7L326.6 217.4C314.1 204.9 293.8 204.9 281.3 217.4L185.3 313.4C172.8 325.9 172.8 346.2 185.3 358.7C197.8 371.2 218.1 371.2 230.6 358.7L304 285.3L361.4 342.7C373.9 355.2 394.2 355.2 406.7 342.7L534.7 214.7z"/></svg>`,

  operationalEfficiencyChart: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"><!--!Font Awesome Free v7.0.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.--><path d="M329.4 169.4L425.4 73.4C437.9 60.9 458.2 60.9 470.7 73.4L566.7 169.4C579.2 181.9 579.2 202.2 566.7 214.7C554.2 227.2 533.9 227.2 521.4 214.7L480 173.3L480 288L544 288C561.7 288 576 302.3 576 320C576 337.7 561.7 352 544 352L224 352L224 466.7L265.4 425.3C277.9 412.8 298.2 412.8 310.7 425.3C323.2 437.8 323.2 458.1 310.7 470.6L214.7 566.6C202.2 579.1 181.9 579.1 169.4 566.6L73.4 470.6C60.9 458.1 60.9 437.8 73.4 425.3C85.9 412.8 106.2 412.8 118.7 425.3L160 466.7L160 352L96 352C78.3 352 64 337.7 64 320C64 302.3 78.3 288 96 288L416 288L416 173.3L374.6 214.7C362.1 227.2 341.8 227.2 329.3 214.7C316.8 202.2 316.8 181.9 329.3 169.4zM480 400L480 544C480 561.7 465.7 576 448 576C430.3 576 416 561.7 416 544L416 400L480 400zM160 240L160 96C160 78.3 174.3 64 192 64C209.7 64 224 78.3 224 96L224 240L160 240z"/></svg>`,
  ...
  // Headcount By Department Icon (building/office icon) - TEST WITH STAR ICON
...
export function getKpiIcon(kpiName: string): string {
  const iconMap: { [key: string]: string } = {
    // Standard KPI mappings (camelCase)
    ...
    // Business Flow Icons (kebab-case)
    'conversion-rate': KPI_ICONS.conversionRate,
...
export function getChartIcon(chartName: string): string {
  const iconMap: { [key: string]: string } = {
    ...
    // Strategic Executive Chart Icons (menggunakan icon trend khusus)
    'GGR USER TREND': KPI_ICONS.ggrUserTrend,
    'GGR PURE USER TREND': KPI_ICONS.ggrPureUserTrend,
    'CUSTOMER VALUE PER HEADCOUNT': KPI_ICONS.customerValue,
    'CUSTOMER COUNT VS HEADCOUNT': KPI_ICONS.customerCount,
    'HEADCOUNT BY DEPARTMENT': KPI_ICONS.headcountByDepartment,
    
    // Fallback untuk chart yang tidak ada mapping khusus
    'GGR User': KPI_ICONS.ggrUser,
    'GGR Pure User': KPI_ICONS.ggrPureUser,
