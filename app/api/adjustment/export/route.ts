...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log('📥 Exporting adjusment_daily data with filters:', { 
    ...
    console.log(`📊 Exporting ${data.length} adjusment_daily records`)
    ...
    const filename = `adjusment_daily_data_${filterStr}_${timestamp}.csv`
