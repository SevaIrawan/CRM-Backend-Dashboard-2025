...
export async function GET(request: NextRequest) {
  ...
  try {
    console.log('📊 Fetching adjustment data with filters:', { 
    ...
    console.log(`📊 Total adjustment records found: ${totalRecords}`)
    ...
    console.log(`✅ Found ${result.data?.length || 0} adjustment records (Page ${page} of ${totalPages})`)
