...
export async function GET(request: NextRequest) {
  ...
  try {
    console.log('🔍 [USC Churn Member API] Fetching slicer options for USC currency lock')
    ...
    console.log('🔍 [USC Churn Member] Raw months data from DB:', {
    ...
    console.log('🔍 [USC Churn Member] Month-year mapping:', monthYearMap)
    ...
    console.log('✅ [USC Churn Member API] Slicer options loaded with USC currency lock:', {
    ...
    console.error('❌ [USC Churn Member API] Error getting slicer options:', error)
    return NextResponse.json({ 
      success: false, 
