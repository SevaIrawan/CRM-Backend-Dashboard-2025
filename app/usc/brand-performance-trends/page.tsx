...
export default function BrandPerformanceTrendsPage() {
  ...
  const handleExportCSV = async () => {
    ...
    try {
      ...
      const res = await fetch(`/api/usc-brand-performance-trends/export?${params}`, {
        headers: {
      ...
      a.href = url
      a.download = `brand_performance_trends_usc_${periodBEnd}.csv`
    ...
    <Layout customSubHeader={customSubHeader} pageInsights={calculateInsights}>
      <Frame variant="standard">
        ...
        <div style={{
          ...
          {loading && <StandardLoadingSpinner message="Loading Brand Performance Trends USC" />}
