            ...
            <>
              ...
              <div className="kpi-row" style={{ display: 'grid', gridTemplateColumns: 'repeat(6, 1fr)', gap: '18px', marginBottom: '24px' }}>
                ...
                <ComparisonStatCard
                  ...
                  valueA={formatKPIValue(data.comparison.periodA.depositAmount, 'currency')}
                  valueB={formatKPIValue(data.comparison.periodB.depositAmount, 'currency')}
                  additionalKpi={{
                    label: "Compare (B-A)",
                ...
                <ComparisonStatCard
                  ...
                  valueA={formatKPIValue(data.comparison.periodA.netProfit, 'currency')}
                  valueB={formatKPIValue(data.comparison.periodB.netProfit, 'currency')}
                  additionalKpi={{
                    label: "Compare (B-A)",
                ...
                <ComparisonStatCard
                  title="DA USER A|B"
                  valueA={formatKPIValue(data.comparison.periodA.daUser, 'currency')}
                  valueB={formatKPIValue(data.comparison.periodB.daUser, 'currency')}
                  additionalKpi={{
                    label: "Compare (B-A)",
                ...
                <ComparisonStatCard
                  title="GGR USER A|B"
                  valueA={formatKPIValue(data.comparison.periodA.ggrUser, 'currency')}
                  valueB={formatKPIValue(data.comparison.periodB.ggrUser, 'currency')}
                  additionalKpi={{
                    label: "Compare (B-A)",
