...
export default function MYRCustomerRetentionPage() {
  ...
  const fetchCustomerRetentionData = async () => {
    ...
    try {
      ...
      console.error('Error fetching myr-customer-retention data:', error)
      setCustomerRetentionData([])
      setLoading(false)
    }
  }
  ...
  const setDateRangeFromMonth = async (selectedMonth: string, selectedYear: string) => {
    ...
    try {
      ...
      const response = await fetch(`/api/myr-customer-retention/month-max-date?month=${selectedMonth}&year=${yearValue}&line=${line}`, {
        headers: {
          'x-user-allowed-brands': JSON.stringify(allowedBrands)
        }
      })
    ...
    try {
      ...
      if (response.ok) {
        ...
        const filename = contentDisposition 
          ...
          : 'myr_customer_retention_export.csv'
          ...
          {loading ? (
            ...
            <div className="empty-container">
              ...
              <div className="empty-text">
                No MYR customer retention data found for the selected filters
              </div>
            </div>
          ) : (
            <>
