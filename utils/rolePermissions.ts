...
export const hasPermission = (userRole: string, pagePath: string): boolean => {
  ...
  const pathToPermission: { [key: string]: string } = {
    ...
    '/member-analytics/overview': 'member-analytics',
    '/member-analytics/growth': 'member-analytics',
    '/member-analytics/behavior': 'member-analytics',
    '/member-analytics/performance': 'member-analytics',
    '/member-analytics/predictive': 'member-analytics',
    '/member-analytics/segmentation': 'member-analytics',
    '/xoo': 'xoo',
    '/os': 'os',
...
export const getMenuItemsByRole = (userRole: string) => {
  ...
  const allMenuItems = [
    ...
    { title: 'Member Analytics', path: '/member-analytics', permission: 'member-analytics', hasSubmenu: true },
